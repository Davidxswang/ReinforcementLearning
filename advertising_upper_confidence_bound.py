...
if __name__ == '__main__':
    bandit_payout = [0.01, 0.015, 0.03] # true CTR
    bandit_reward = [1, 1, 1]           # reward for each ad
    ...
    for episode in range(n_episode):
        action = upper_confidence_bound(Q, 0, action_count, episode)
    ...
    plt.savefig('advertising_upper_confidence_bound.png')